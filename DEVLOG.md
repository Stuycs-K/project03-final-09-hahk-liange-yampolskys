...
Decided to make a menu for loading, adding, saving, etc. Changed main.c to print the menu out and use scanf for user input. Changed load_library to use buffer to handle file input. Also added add_library. Next steps will be to finish main.c and other library functions.